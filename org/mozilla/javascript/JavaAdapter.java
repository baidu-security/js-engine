...
public final class JavaAdapter implements IdFunctionCall
{
                                           ...
                                           String scriptClassName)
    {
        ClassFileWriter cfw = new ClassFileWriter(adapterName,
                                                  superClass.getName(),
                                                  "<adapter>");
        cfw.addField("factory", "Lcom/baidu/openrasp/org/mozilla/javascript/ContextFactory;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("delegee", "Lcom/baidu/openrasp/org/mozilla/javascript/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("self", "Lcom/baidu/openrasp/org/mozilla/javascript/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
                                     ...
                                     String superName, Constructor<?> superCtor)
    {
        ...
        if (parameters.length == 0) {
            cfw.startMethod("<init>",
                        ...
                        +"Lcom/baidu/openrasp/org/mozilla/javascript/ContextFactory;)V",
            ...
            StringBuilder sig = new StringBuilder(
                    "(Lcom/baidu/openrasp/org/mozilla/javascript/Scriptable;"
                    +"Lcom/baidu/openrasp/org/mozilla/javascript/ContextFactory;");
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "com/baidu/openrasp/org/mozilla/javascript/JavaAdapter",
                                          ...
                                          String scriptClassName)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "com/baidu/openrasp/org/mozilla/javascript/JavaAdapter",
                      "runScript",
                      "(Lcom/baidu/openrasp/org/mozilla/javascript/Script;"
                      +")Lcom/baidu/openrasp/org/mozilla/javascript/Scriptable;");
                                     ...
                                     boolean callConvertResult)
    {
        ...
        if (retType == Void.TYPE) {
            ...
            cfw.addInvoke(ByteCode.INVOKESTATIC,
                          "com/baidu/openrasp/org/mozilla/javascript/Context",
